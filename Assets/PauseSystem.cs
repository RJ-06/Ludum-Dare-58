...
//     version 1.14.2
//     from Assets/PauseSystem.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/PauseSystem.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PauseSystem: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Game"",
            ""id"": ""57185899-6643-428a-8a27-023d95d6b596"",
            ""actions"": [
                {
                    ""name"": ""PauseGame"",
                    ""type"": ""Button"",
                    ""id"": ""ce21424c-73e0-478e-bea2-04ea56846d85"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""fd572e5e-6cb1-4032-b8f6-19801590b1ab"",
    ...
    ~@PauseSystem()
    {
        UnityEngine.Debug.Assert(!m_Game.enabled, "This will cause a leak and performance issues, PauseSystem.Game.Disable() has not been called.");
    }
    ...
    {
        private @PauseSystem m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public GameActions(@PauseSystem wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Game/PauseGame".
        /// </summary>
